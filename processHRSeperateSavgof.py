...
class ProcessHR():
    ...
    def processRawData(self, dataTitle = None):
        ...
        DepthROI2 = scipy.signal.savgol_filter(DepthROI2, 9, 2, mode='nearest', axis=0)
        IROI2 = scipy.signal.savgol_filter(IROI2, 5, 2, mode='nearest', axis=0)
        ...
        I_comp = depth_compensator.run(I_raw, Depth, window_length=2, fps=30)
      #  scipy.io.savemat('main_intensity_compensated.mat', {'main_icomp': I_comp})  
        plt.plot(I_raw[2,:])
        plt.show()
