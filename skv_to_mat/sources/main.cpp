...
int main()
{
	...
	for (size_t l = 1; l < skvs.size(); ++l)
	{
		...
		std::cout << "frames dimensions	: width=" << camera_parameters.width << " height=" << camera_parameters.height << std::endl;

		std::cout << "intrinsics		: fx=" << camera_parameters.focal_x << " fy=" << camera_parameters.focal_y << " cx=" << camera_parameters.central_x << " cy=" << camera_parameters.central_y << std::endl;

		std::cout << "Lens			: k1=" << camera_parameters.k1 << " k2=" << camera_parameters.k2 << " k3=" << camera_parameters.k3 << " p1=" << camera_parameters.p1 << " p2=" << camera_parameters.p2 << std::endl;
